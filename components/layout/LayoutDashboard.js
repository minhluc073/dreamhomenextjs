...
export default function LayoutDashboard({ children }) {
      ...
      const handleSidebar = () => {
          ...
          !isSidebar ? document.body.classList.add("sidebar-enable") : document.body.classList.remove("sidebar-enable");
      };
    return (
        <>
            <div id="wrapper">
                <div id="pagee" className="clearfix">
                                    ...
                                    <div className="col-lg-12">
                                        <div className="inner-container d-flex justify-content-between align-items-center">
                                            ...
                                            <div className="header-account flex align-center">
                                                <div className="avatars-box flex align-center">
                                                    <div className="images flex-none">
                                                        <img src="/assets/images/author/author-dashboard-top.jpg" alt />
                                                    </div>
                                                    <div className="title-avatar fw-6"><Link href="#">Themesflat</Link></div>
                                                </div>
                                                <div className="flat-bt-top sc-btn-top">
                                                    <Link className="sc-button btn-icon " href="/properties-list">
                                            ...
                                            <div className="mobile-nav-toggler mobile-button"><span /></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="mobile-menu">
                        ...
                        <nav className="menu-box">
                            <div className="nav-logo"><Link href="/"><img src="/assets/images/logo/logo@2x.png" alt width={197} height={48} /></Link></div>
                            <div className="bottom-canvas">
                                <div className="login-box flex align-center">
                                    ...
                                    <Link href="#" data-toggle="modal" data-target="#popup_bid" className="fw-7 font-2">Login</Link>
                                </div>
                                <div className="menu-outer" />
                                <div className="button-mobi-sell">
                                    <Link className="sc-button btn-icon center" href="/properties-list">
                                        <svg width={25} height={24} viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M13.25 15.75V15H11.375C10.7547 15 10.25 14.4953 10.25 13.875V12.375C10.25 11.7547 10.7547 11.25 11.375 11.25H11.75V10.5H13.25V11.25H14C14.1989 11.25 14.3897 11.329 14.5303 11.4697C14.671 11.6103 14.75 11.8011 14.75 12C14.75 12.1989 14.671 12.3897 14.5303 12.5303C14.3897 12.671 14.1989 12.75 14 12.75H11.75V13.5H13.625C14.2453 13.5 14.75 14.0047 14.75 14.625V16.125C14.75 16.7453 14.2453 17.25 13.625 17.25H13.25V18H11.75V17.25H11C10.8011 17.25 10.6103 17.171 10.4697 17.0303C10.329 16.8897 10.25 16.6989 10.25 16.5C10.25 16.3011 10.329 16.1103 10.4697 15.9697C10.6103 15.829 10.8011 15.75 11 15.75H13.25Z" fill="white" />
                                            <path d="M22.469 10.6447L14.315 2.96925C13.8234 2.50736 13.1742 2.25024 12.4996 2.25024C11.825 2.25024 11.1759 2.50736 10.6842 2.96925L8.74998 4.791V3C8.74998 2.80109 8.67096 2.61032 8.53031 2.46967C8.38966 2.32902 8.19889 2.25 7.99998 2.25H4.99998C4.80107 2.25 4.6103 2.32902 4.46965 2.46967C4.329 2.61032 4.24998 2.80109 4.24998 3V9.027L2.55273 10.6252C2.03748 11.0722 1.86348 11.784 2.10798 12.4387C2.34873 13.0837 2.93823 13.5 3.60948 13.5H4.24998V21C4.24998 21.1989 4.329 21.3897 4.46965 21.5303C4.6103 21.671 4.80107 21.75 4.99998 21.75H20C20.1989 21.75 20.3897 21.671 20.5303 21.5303C20.671 21.3897 20.75 21.1989 20.75 21V13.5H21.389C22.061 13.5 22.6512 13.083 22.892 12.438C23.1357 11.7832 22.961 11.0715 22.469 10.6447ZM5.74998 3.75H7.24998V6.2025L5.74998 7.61475V3.75ZM21.4865 11.9138C21.4542 12 21.4047 12 21.389 12H20C19.8011 12 19.6103 12.079 19.4697 12.2197C19.329 12.3603 19.25 12.5511 19.25 12.75V20.25H5.74998V12.75C5.74998 12.5511 5.67096 12.3603 5.53031 12.2197C5.38966 12.079 5.19889 12 4.99998 12H3.60948C3.59373 12 3.54498 12 3.51273 11.9138C3.50022 11.8834 3.49792 11.8498 3.50617 11.818C3.51442 11.7862 3.53278 11.7579 3.55848 11.7375L11.7125 4.062C11.9257 3.86178 12.2071 3.75032 12.4996 3.75032C12.7921 3.75032 13.0735 3.86178 13.2867 4.062L21.4625 11.7578C21.5187 11.8058 21.4977 11.883 21.4865 11.9138Z" fill="white" />
                                        </svg>
                                    ...
                                    <div className="box flex">
                                        <div className="icon">
                                            <svg width={40} height={41} viewBox="0 0 50 51" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M26.4648 13.7812C26.4648 14.5902 27.1207 15.2461 27.9297 15.2461C28.7387 15.2461 29.3945 14.5902 29.3945 13.7812C29.3945 12.9723 28.7387 12.3164 27.9297 12.3164C27.1207 12.3164 26.4648 12.9723 26.4648 13.7812Z" fill="#E5E5EA" />
                                                <path d="M32.3242 13.7812C32.3242 14.5902 32.9801 15.2461 33.7891 15.2461C34.598 15.2461 35.2539 14.5902 35.2539 13.7812C35.2539 12.9723 34.598 12.3164 33.7891 12.3164C32.9801 12.3164 32.3242 12.9723 32.3242 13.7812Z" fill="#E5E5EA" />
                                                <path d="M38.1836 13.7812C38.1836 14.5902 38.8395 15.2461 39.6484 15.2461C40.4574 15.2461 41.1133 14.5902 41.1133 13.7812C41.1133 12.9723 40.4574 12.3164 39.6484 12.3164C38.8395 12.3164 38.1836 12.9723 38.1836 13.7812Z" fill="#E5E5EA" />
                                                <path d="M22.6771 37.2188L27.0716 34.2891L35.8398 37.2188V43.0781C35.8398 44.6961 34.549 46.0078 32.931 46.0078C16.7508 46.0078 1.46484 30.8195 1.46484 14.6394C1.46484 13.0214 2.77656 11.7305 4.39453 11.7305H10.2539L13.1836 20.4987L10.2539 24.8933C12.1247 29.5703 18 35.3479 22.6771 37.2188Z" stroke="#E5E5EA" strokeWidth="1.7" strokeMiterlimit={10} strokeLinecap="round" strokeLinejoin="round" />
                                                <path d="M19.1406 13.7812C19.1406 18.6354 23.0756 22.5703 27.9297 22.5703V28.4297L33.7891 22.5703H39.6484C44.5025 22.5703 48.5352 18.6354 48.5352 13.7812C48.5352 8.92715 44.5025 4.99219 39.6484 4.99219H27.9297C23.0756 4.99219 19.1406 8.92715 19.1406 13.7812Z" stroke="#E5E5EA" strokeWidth="1.7" strokeMiterlimit={10} strokeLinecap="round" strokeLinejoin="round" />
                                            </svg>
                                        </div>
                                    ...
                                    <div className="box flex">
                                        <div className="icon">
                                            <svg width={40} height={40} viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M36.6559 17.8341L36.6559 17.8341L36.6609 17.8392C36.8315 18.0113 37.0549 18.0969 37.2788 18.0969C37.5021 18.0969 37.7258 18.0116 37.8976 17.8411C38.2409 17.5005 38.241 16.9425 37.8996 16.5985C37.5586 16.2548 37.0037 16.2526 36.66 16.5934L36.6559 17.8341ZM36.6559 17.8341L36.6551 17.8332M36.6559 17.8341L36.6551 17.8332M36.6551 17.8332C36.3141 17.4895 36.3163 16.9345 36.66 16.5935L36.6551 17.8332Z" fill="#E5E5EA" stroke="white" strokeWidth="0.2" />
                                                <path d="M46.4639 27.8825H46.7054L46.5346 27.7118L39.3343 20.5115C38.992 20.1691 38.992 19.6141 39.3343 19.2718C39.6767 18.9296 40.2317 18.9296 40.574 19.2718L49.6441 28.3419C49.8085 28.5063 49.9009 28.7294 49.901 28.9618C49.901 29.1943 49.8086 29.4172 49.6442 29.5816L34.0757 45.1502C33.9114 45.3145 33.6884 45.4069 33.4559 45.4069C33.2235 45.4069 33.0005 45.3145 32.8361 45.1502L9.34306 21.6572C9.34306 21.6572 9.34305 21.6572 9.34305 21.6572C9.00075 21.3148 9.00076 20.7598 9.34305 20.4175L24.9114 4.84884C25.2537 4.50664 25.8087 4.50664 26.151 4.84884C26.151 4.84884 26.151 4.84884 26.1511 4.84884L34.9723 13.67C35.3146 14.0124 35.3146 14.5675 34.9723 14.9098C34.6299 15.252 34.0749 15.2519 33.7326 14.9098L26.7811 7.95839L26.6104 7.78768V8.0291V25.1994C26.6104 26.679 27.8139 27.8825 29.2935 27.8825H46.4639ZM24.8575 7.62373V7.38231L24.6868 7.55302L12.2497 19.9901L12.079 20.1608H12.3204H24.7575H24.8575V20.0608V7.62373ZM32.4087 42.2434L32.5794 42.4141V42.1727V29.7356V29.6356H32.4794H29.2937C26.8477 29.6356 24.8575 27.6455 24.8575 25.1994V22.0139V21.9139H24.7575H12.3204H12.079L12.2497 22.0846L32.4087 42.2434ZM34.3324 42.1728V42.4142L34.5031 42.2435L46.9401 29.8064L47.1108 29.6356H46.8694H34.4324H34.3324V29.7356V42.1728Z" fill="#E5E5EA" stroke="white" strokeWidth="0.2" />
                                                <path d="M0.976562 24.9047H6.70225C7.18637 24.9047 7.57881 25.2972 7.57881 25.7812C7.57881 26.2654 7.18637 26.6578 6.70225 26.6578H0.976562C0.492442 26.6578 0.1 26.2653 0.1 25.7812C0.1 25.2972 0.492442 24.9047 0.976562 24.9047Z" fill="#E5E5EA" stroke="white" strokeWidth="0.2" />
                                                <path d="M9.59961 24.9047H9.61426C10.0984 24.9047 10.4908 25.2972 10.4908 25.7812C10.4908 26.2653 10.0984 26.6578 9.61426 26.6578H9.59961C9.11549 26.6578 8.72305 26.2653 8.72305 25.7812C8.72305 25.2972 9.11549 24.9047 9.59961 24.9047Z" fill="#E5E5EA" stroke="white" strokeWidth="0.2" />
                                                <path d="M0.978516 14.6508H4.10381C4.58793 14.6508 4.98037 15.0433 4.98037 15.5273C4.98037 16.0114 4.58793 16.4039 4.10381 16.4039H0.978516C0.494395 16.4039 0.101953 16.0114 0.101953 15.5273C0.101953 15.0433 0.494395 14.6508 0.978516 14.6508Z" fill="#E5E5EA" stroke="white" strokeWidth="0.2" />
                                                <path d="M7.29315 14.6508H10.9873C11.4714 14.6508 11.8639 15.0433 11.8639 15.5273C11.8639 16.0114 11.4714 16.4039 10.9873 16.4039H7.29315C6.80903 16.4039 6.41659 16.0114 6.41659 15.5273C6.41659 15.0433 6.80903 14.6508 7.29315 14.6508Z" fill="#E5E5EA" stroke="white" strokeWidth="0.2" />
                                                <path d="M7.64453 30.2758H13.1132C13.5972 30.2758 13.9897 30.6683 13.9897 31.1523C13.9897 31.6364 13.5973 32.0289 13.1132 32.0289H7.64453C7.16041 32.0289 6.76797 31.6364 6.76797 31.1523C6.76797 30.6683 7.16041 30.2758 7.64453 30.2758Z" fill="#E5E5EA" stroke="white" strokeWidth="0.2" />
                                                <path d="M3.61328 36.5258H17.3827C17.8668 36.5258 18.2593 36.9183 18.2593 37.4023C18.2593 37.8864 17.8668 38.2789 17.3827 38.2789H3.61328C3.12916 38.2789 2.73672 37.8864 2.73672 37.4023C2.73672 36.9183 3.12916 36.5258 3.61328 36.5258Z" fill="#E5E5EA" stroke="white" strokeWidth="0.2" />
                                            </svg>
                                        </div>
                                        <div className="content fs-13 lh-16">
                                            Email: <h5>themesflat@gmail.com</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    {/* End Mobile Menu */}
                    <div className="btn2 header-item " id="left-menu-btn" onClick={handleSidebar}>
                    ...
                    <div className="left-menu">
                        ...
                        <div id="sidebar-menu">
                            ...
                            <div className="logo-box d-flex">
                                <div className="logo">
                                    <Link href="/">
                                        <img src="/assets/images/logo/logo3@2x.png" alt width={197} height={48} className="img-logo" />
                                        <img src="/assets/images/logo/toggle-logo@2x.png" alt width={46} height={48} className="toggle-logo" />
                                    </Link>
                                </div>
                            </div>
                            <div className="profile-box">
                                ...
                                <div className="avatar-box flex align-center">
                                    ...
                                    <div className="content">
                                        ...
                                        <div className="titles fw-6"><Link href="#">themesflat@gmail...</Link> </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <ul className="downmenu list-unstyled" id="side-menu">
                                <li>
                                    <Link href="/dashboard" className="tf-effect">
                                        <span className="icon-dash dash-icon">
                                            <svg width={22} height={22} viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <g>
                                                    ...
                                                    <path fillRule="evenodd" clipRule="evenodd" d="M15.2939 1.83331H6.70346C3.70902 1.83331 1.83203 3.95272 1.83203 6.95304V15.0469C1.83203 18.0472 3.70029 20.1666 6.70346 20.1666H15.2939C18.2971 20.1666 20.1654 18.0472 20.1654 15.0469V6.95304C20.1654 3.95272 18.2971 1.83331 15.2939 1.83331Z" stroke="#F1FAEE" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                                </g>
                                            </svg>
                                        </span>
                                ...
                                <li>
                                    <Link href="/dashboard-profile" className="has-arrow tf-effect">
                                        <span className="icon-dash dash-icon">
                                            <svg width={22} height={22} viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path fillRule="evenodd" clipRule="evenodd" d="M10.987 14.0674C7.44168 14.0674 4.41406 14.6034 4.41406 16.7502C4.41406 18.8969 7.42247 19.4521 10.987 19.4521C14.5323 19.4521 17.5591 18.9152 17.5591 16.7694C17.5591 14.6235 14.5515 14.0674 10.987 14.0674Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                                <path fillRule="evenodd" clipRule="evenodd" d="M10.9866 11.0054C13.3132 11.0054 15.1989 9.11885 15.1989 6.79226C15.1989 4.46567 13.3132 2.57996 10.9866 2.57996C8.66005 2.57996 6.77346 4.46567 6.77346 6.79226C6.7656 9.11099 8.6391 10.9976 10.957 11.0054H10.9866Z" stroke="white" strokeWidth="1.42857" strokeLinecap="round" strokeLinejoin="round" />
                                            </svg>
                                        </span>
                                ...
                                <li>
                                    <Link href="/dashboard-review" className="tf-effect">
                                        <span className="icon-work dash-icon">
                                            <svg width={22} height={22} viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M16.4076 8.11353L12.3346 11.4255C11.5651 12.036 10.4824 12.036 9.71285 11.4255L5.60547 8.11353" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                        ...
                                        <span className="dash-titles">Review</span>
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/dashboard-properties" className="tf-effect">
                                        <span className="icon-applicant dash-icon">
                                            <svg width={22} height={22} viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M10.533 2.55658H7.10561C4.28686 2.55658 2.51953 4.55216 2.51953 7.37733V14.9985C2.51953 17.8237 4.27861 19.8192 7.10561 19.8192H15.1943C18.0222 19.8192 19.7813 17.8237 19.7813 14.9985V11.3062" stroke="#F1FAEE" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                                <path fillRule="evenodd" clipRule="evenodd" d="M8.09012 10.0108L14.9404 3.16055C15.7938 2.30805 17.177 2.30805 18.0305 3.16055L19.146 4.27614C19.9995 5.12955 19.9995 6.51372 19.146 7.36622L12.2628 14.2495C11.8897 14.6226 11.3837 14.8325 10.8557 14.8325H7.42188L7.50804 11.3675C7.52087 10.8578 7.72896 10.372 8.09012 10.0108Z" stroke="#F1FAEE" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                ...
                                <li>
                                    <Link href="#" className=" tf-effect">
                                        <span className="icon-submit dash-icon">
                                            <svg width={22} height={22} viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path fillRule="evenodd" clipRule="evenodd" d="M17.4808 17.4807C14.6793 20.2825 10.531 20.8878 7.13625 19.3178C6.6351 19.1161 6.22423 18.953 5.83362 18.953C4.74565 18.9594 3.39143 20.0144 2.68761 19.3114C1.98379 18.6075 3.03952 17.2522 3.03952 16.1577C3.03952 15.767 2.88291 15.3635 2.68116 14.8613C1.11046 11.4671 1.71663 7.31744 4.5181 4.51659C8.09433 0.939042 13.9045 0.939042 17.4808 4.51566C21.0635 8.09874 21.057 13.9041 17.4808 17.4807Z" stroke="#F1FAEE" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                                <path d="M14.6105 11.3786H14.6187" stroke="#F1FAEE" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
                                                <path d="M10.9347 11.3786H10.9429" stroke="#F1FAEE" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
                                                <path d="M7.2589 11.3786H7.26715" stroke="#F1FAEE" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
                                            </svg>
                                        </span>
                                        <span className="dash-titles">Message</span>
                                    </Link>
                                </li>
                                <li>
                                    <Link href="#" className="tf-effect">
                                        ...
                                        <span className="dash-titles">My favorite</span>
                                    </Link>
                                </li>
                                <li>
                                    <Link href="#" className="tf-effect">
                                        <span className="icon-bell1 dash-icon">
                                            <svg width={22} height={22} viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <circle cx="10.7864" cy="10.786" r="8.23951" stroke="#F1FAEE" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                                <path d="M16.5156 16.9447L19.746 20.1667" stroke="#F1FAEE" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            </svg>
                                        </span>
                                        <span className="dash-titles">Save search</span>
                                    </Link>
                                </li>
                                <li>
                                    <Link href="#" className="tf-effect">
                                        <span className="icon-change-passwords dash-icon">
                                            <svg width={22} height={22} viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path fillRule="evenodd" clipRule="evenodd" d="M16.6729 4.88599C18.222 4.88599 19.4687 6.14182 19.4687 7.69099V10.8443C17.2137 12.1643 14.2345 12.9618 10.9895 12.9618C7.74453 12.9618 4.77453 12.1643 2.51953 10.8443V7.68182C2.51953 6.13265 3.77536 4.88599 5.32453 4.88599H16.6729Z" stroke="#F1FAEE" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                                <path d="M14.2018 4.88196V4.54646C14.2018 3.42813 13.2943 2.52063 12.176 2.52063H9.81099C8.69266 2.52063 7.78516 3.42813 7.78516 4.54646V4.88196" stroke="#F1FAEE" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                                <path d="M2.54297 14.1927L2.71622 16.4927C2.83355 18.0427 4.12514 19.2408 5.67889 19.2408H16.3113C17.8651 19.2408 19.1566 18.0427 19.274 16.4927L19.4472 14.1927" stroke="#F1FAEE" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            </svg>
                                        </span>
                                        <span className="dash-titles">My package</span>
                                    </Link>
                                </li>
                                <li>
                                    <Link href="#" className="tf-effect">
