...
export default function LoginModal({ handleLogin, isLogin }) {
    return (
        <>
            <div className={`modal fade popup ${isLogin ? "show d-block" : ""}`} id="popup_bid" tabIndex={-1} role="dialog" aria-hidden="true">
                <div className="modal-dialog modal-dialog-centered" role="document">
                    <div className="modal-content">
                        <button type="button" className="close" data-dismiss="modal" aria-label="Close" onClick={handleLogin}>
                        ...
                        <div className="modal-body space-y-20 pd-40">
                            <div className="wrap-modal flex">
                                ...
                                <div className="content">
                                        ...
                                        <div className="respond-comment">
                                            <form method="post" className="comment-form form-submit" action="#" acceptCharset="utf-8">
                                                <fieldset className>
                                                    ...
                                                    <img className="img-icon img-email" src="assets/images/icon/icon-gmail.svg" alt="images" />
                                                </fieldset>
                                    ...
                                    <div className="text-box text-center fs-13">Don’t you have an account?  <a className="font-2 fw-7 fs-13 color-popup text-color-3" data-toggle="modal" data-target="#popup_bid2" data-dismiss="modal" aria-label="Close">Register</a></div>
                                    <p className="texts fs-13 text-center">or login with</p>
