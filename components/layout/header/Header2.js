    ...
    return (
        <>
            <div>
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="inner-container d-flex justify-content-between align-items-center">
                                    <div className="icon-tell-box flex align-center">
                                        <div className="icon flex-none">
                                            <svg width={50} height={50} viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <g opacity="0.9">
                                                    <path fillRule="evenodd" clipRule="evenodd" d="M7.26135 17.3176L10.3744 14.2041C10.8085 13.7699 11.3522 13.5664 11.9646 13.6085C12.577 13.6507 13.0877 13.9271 13.4581 14.4166L18.0679 20.5097C18.6893 21.331 18.611 22.4676 17.8827 23.1959L15.7252 25.3537C19.0452 28.1764 21.8211 30.9536 24.6433 34.2735L26.8013 32.1152C27.5296 31.3868 28.666 31.3086 29.4872 31.9301L35.5794 36.5405C36.0689 36.9109 36.3452 37.4216 36.3874 38.0341C36.4296 38.6466 36.226 39.1904 35.7919 39.6245L32.6783 42.7385C25.5089 49.909 0.0917082 24.4882 7.26135 17.3176ZM33.8537 6C39.4572 6 43.9997 10.2467 43.9997 15.4854C43.9997 20.724 39.4572 24.9707 33.8537 24.9707C31.9295 24.9707 30.1305 24.4699 28.5975 23.6002C27.3492 24.1528 26.0098 24.3125 24.728 24.123C25.208 23.2144 25.5656 22.2462 25.7915 21.2437C24.4847 19.647 23.7077 17.6511 23.7077 15.4854C23.7077 10.2467 28.2502 6 33.8537 6Z" stroke="#FFA920" strokeMiterlimit="22.9256" strokeLinecap="round" strokeLinejoin="round" />
                                                    <path d="M33.8308 20.0552V14.4344H32.5506M32.4907 20.1123H35.171M33.8308 10.7305V10.7595" stroke="#FFA920" strokeMiterlimit="22.9256" strokeLinecap="round" strokeLinejoin="round" />
                                                </g>
                                            </svg>
                                        </div>
                                        <div className="content">
                                            <p className="text-color-2">Call us:</p>
                                            <Link href="/tel:0123456789"><h5 className="fw-6 text-color-3">(201) 555-0124</h5></Link>
                                        </div>
                                    </div>
                                    {/* Logo Box */}
                                    <div className="logo-box d-flex">
                                        <div className="logo"><Link href="/"><img src="/assets/images/logo/logo@2x.png" alt="" width={197} height={48} /></Link></div>
                                    </div>
                ...
                {/* Main Header */}
                <header id="header" className={`main-header home2 header  header-fixed style-absolute  ${scroll ? "is-fixed is-small" : ""}`}>
                    {/* Header Lower */}
                            ...
                            <div className="row">
                                <div className="col-lg-12">
                                    <div className="inner-container flex justify-space align-center">
                                        <div id="showlogo">
                                            <Link href="/">
                                                <img id="theImg" src="assets/images/logo/logo2.png" />
                                            </Link>
                                        </div>
                                        ...
                                        {/*  */}
                                        <div className="flex">
                                            <div className="icon-socials box-3 text-color-1 flex align-center ">
                                                <Link href="#"><i className="fab fa-facebook-f" /></Link>
                                                <Link href="#"><i className="fab fa-twitter" /></Link>
                                                <Link href="#"><i className="fab fa-linkedin-in" /></Link>
                                                <Link href="#"><i className="fab fa-instagram" /></Link>
                                            </div>
                                            <div className="form-group-1 search-form">
                                                <input type="search" className="search-field" placeholder="Search..." title="Search for" required />
                                            </div>
                                        </div>
