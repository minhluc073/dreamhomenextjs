                                ...
                                <div className="box-tab center">
                                    <ul className="menu-tab tab-title flex">
                                        <li className={activeIndex == 1 ? "item-title active flex align-center" : "item-title flex align-center"} onClick={() => handleOnClick(1)}>
                                            <i className="far fa-check-circle" /> <h4 className="inner">Rent</h4>
                                        </li>
                                            ...
                                            <form method="post">
                                                <div className="wd-find-select flex">
                                                    ...
                                                    <div className="form-group-4 form-style">
                                                        <a className="icon-filter button-top pull-right" onClick={handleToggle}>
                                                            <span>Filters</span>
                                                    ...
                                                    <div className="button-search sc-btn-top">
                                                        <Link className="sc-button button-top" href="#">
