              ...
              <div className="col-lg-12">
                <div className="content po-content-two">
                  <div className="heading center">
                    <h1
                      className="text-color-1 wow fadeInDown js-letters"
                      data-wow-delay="50ms"
                      data-wow-duration="1000ms"
                    >
                      Choose your home for future life
                    </h1>
                    <p className="fs-16 lh-24 text-color-1 fw-6">
                              ...
                              <div className="form-group-2 form-style">
                                <div className="group-select select-wrapper">
                                  <select className="nice-select" tabIndex={0}>
                                    ...
                                    <option value="bungalow" className="option">
                                      Bungalow
                                    </option>
                                    <option
                                      value="apartment"
                              ...
                              <div className="form-group-3 form-style">
                                <div className="group-select select-wrapper">
                                  <select className="nice-select" tabIndex={0}>
                                    ...
                                    <option value="Japan" className="option">
                                      Japan
                                    </option>
                                    <option
                                      value="America"
