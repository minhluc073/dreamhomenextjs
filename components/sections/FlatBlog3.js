...
export default function FlatBlog3() {
    return (
        <>
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-lg-4 col-md-4">
                            <div className="box hover-img">
                                <div className="images img-style relative ">
                                    <Link href="/blog-detail"><img src="/assets/images/img-box/blog-10.jpg" alt="images" /></Link>
                        ...
                        <div className="col-lg-4 col-md-4">
                            <div className="box hover-img">
                                <div className="images img-style relative ">
                                    <Link href="/blog-detail"><img src="/assets/images/img-box/blog-11.jpg" alt="images" /></Link>
                                    <div className="sub-box flex align-center fs-13 fw-6">
                                        <div className="title-1">April</div><a className="title-2 text-color-3">Housing</a>
                                    </div>
                                </div>
                        ...
                        <div className="col-lg-4 col-md-4">
                            <div className="box hover-img">
                                <div className="images img-style relative ">
                                    <Link href="/blog-detail"><img src="/assets/images/img-box/blog-12.jpg" alt="images" /></Link>
                                    <div className="sub-box flex align-center fs-13 fw-6">
                                        <div className="title-1">April</div><a className="title-2 text-color-3">Housing</a>
                                    </div>
                                </div>
