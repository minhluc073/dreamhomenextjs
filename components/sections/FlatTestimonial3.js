...
export default function FlatTestimonial3() {
    return (
        <>
            ...
            <section className="flat-testimonial3">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="group-testi flex">
                                <div className="wrap-testi">
                                    <div className="swiper-container carousel-7">
                                        <Swiper {...swiperOptions}>
                                            <SwiperSlide>
                                                <div className="box center pt-5">
                                                    <div className="images">
                                                        <img src="/assets/images/author/author-testimonial3.jpg" alt="images" />
                                                    </div>
                                                    <div className="inner">
                                                        <div className="texts font-italic fs-16 fw-5 lh-24">
                                                    ...
                                                    <div className="author-box">
                                                        <h4>Esther Howard</h4>
                                                        <p className="text-color-1">Internet Security Assistant</p>
                                                    </div>
                                                </div>
                                            </SwiperSlide>
                                            <SwiperSlide>
                                ...
                                <div className="wrap-heading">
                                    <div className="box-heading">
                                        <h2 className="text-color-2">From our happy customers</h2>
