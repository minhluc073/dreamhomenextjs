                            ...
                            <div className="col-lg-12">
                                <div className="content po-content-two">
                                    <div className="heading center">
                                        <h1 className="text-color-1 wow slideInDown js-letters" data-wow-delay="50ms" data-wow-duration="1000ms">Choose your home for future life</h1>
                                        <p className="fs-16 lh-24 fw-6 text-color-1">Find a variety of properties that suit you very easily, forget all difficulties in finding a residence for you</p>
                                    </div>
