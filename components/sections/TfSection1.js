...
export default function TfSection1() {
    return (
        <>
            <section className="tf-section flat-testimonial section-mb">
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            ...
                            <div className="box-title flex justify-center">
                                <div className="inner-title flex justify-center align-center"><h4 className="title-1 fw-4">Become our next customer, and find your dream home </h4> <Link href="/tel:0123456789"><h4 className="text-color-3">Contact us: 314-555-0123</h4> </Link></div>
                            </div>
                        </div>
                    </div>
                </div>
