    ...
    return (
        <>
            ...
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Property Listing">
                <div>
                    <section className="tf-section2 flat-agent flat-property page style">
                        <div className="container">
                            <div className="row flex">
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="box hover-img">
                                        <div className="images relative flex-none img-style">
                                            <img src="/assets/images/img-box/agents-1.jpg" alt="images" />
                                        </div>
                                        <div className="content ">
                                            <h3 className="link-style-1"><Link href="/agencies-detail">Darlene Robertson</Link></h3>
                                            <p className>Realtor</p>
                                            <div className="icon-group">
                                                <div className="icon-phone"><Link href="/tel:0123456789" className=" fw-7 font-2">+7-445-556-8337</Link></div>
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="box hover-img">
                                        <div className="images relative flex-none img-style">
                                            <img src="/assets/images/img-box/agents-2.jpg" alt="images" />
                                        </div>
                                        <div className="content ">
                                            <h3 className="link-style-1"><Link href="/agencies-detail">Darlene Robertson</Link></h3>
                                            <p className>Realtor</p>
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="box hover-img">
                                        <div className="images relative flex-none img-style">
                                            <img src="/assets/images/img-box/agents-3.jpg" alt="images" />
                                        </div>
                                        <div className="content ">
                                            <h3 className="link-style-1"><Link href="/agencies-detail">Darlene Robertson</Link></h3>
                                            <p className>Realtor</p>
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="box hover-img">
                                        <div className="images relative flex-none img-style">
                                            <img src="/assets/images/img-box/agents-4.jpg" alt="images" />
                                        </div>
                                        <div className="content ">
                                            <h3 className="link-style-1"><Link href="/agencies-detail">Darlene Robertson</Link></h3>
                                            <p className>Realtor</p>
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="box hover-img">
                                        <div className="images relative flex-none img-style">
                                            <img src="/assets/images/img-box/agents-5.jpg" alt="images" />
                                        </div>
                                        <div className="content ">
                                            <h3 className="link-style-1"><Link href="/agencies-detail">Darlene Robertson</Link></h3>
                                            <p className>Realtor</p>
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="box hover-img">
                                        <div className="images relative flex-none img-style">
                                            <img src="/assets/images/img-box/agents-6.jpg" alt="images" />
                                        </div>
                                        <div className="content ">
                                            <h3 className="link-style-1"><Link href="/agencies-detail">Darlene Robertson</Link></h3>
                                            <p className>Realtor</p>
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="box hover-img">
                                        <div className="images relative flex-none img-style">
                                            <img src="/assets/images/img-box/agents-7.jpg" alt="images" />
                                        </div>
                                        <div className="content ">
                                            <h3 className="link-style-1"><Link href="/agencies-detail">Darlene Robertson</Link></h3>
                                            <p className>Realtor</p>
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="box hover-img">
                                        <div className="images relative flex-none img-style">
                                            <img src="/assets/images/img-box/agents-8.jpg" alt="images" />
                                        </div>
                                        <div className="content ">
                                            <h3 className="link-style-1"><Link href="/agencies-detail">Darlene Robertson</Link></h3>
                                            <p className>Realtor</p>
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="box hover-img">
                                        <div className="images relative flex-none img-style">
                                            <img src="/assets/images/img-box/agents-9.jpg" alt="images" />
                                        </div>
                                        <div className="content ">
                                            <h3 className="link-style-1"><Link href="/agencies-detail">Darlene Robertson</Link></h3>
                                            <p className>Realtor</p>
