    ...
    return (
        <>
            ...
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Property Listing">
                <div>
                    <section className="tf-section2 flat-agencies flat-property style2">
                        <div className="container">
                            <div className="row flex">
                                <div className="col-lg-12">
                                    <div className="category-filter flex justify-space">
                                        ...
                                        <div className="box-2 flex">
                                            <div className="form-group-1 search-group">
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="box box-agencies hover-img2 ">
                                        <div className="images relative img-style2">
                                            <img className="img2" src="/assets/images/img-box/agencies-9.jpg" alt="images" />
                                        </div>
                                        ...
                                        <div className="content">
                                            <div className="title-group">
                                                ...
                                                <p className>2118 Thornridge Cir. Syracuse, Connecticut 35624</p>
                                            </div>
                                            ...
                                            <div className="icon-social-wg style">
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="box box-agencies hover-img2 ">
                                        <div className="images relative img-style2">
                                            <img className="img2" src="/assets/images/img-box/agencies-10.jpg" alt="images" />
                                        </div>
                                        <div className="icon-brand">
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="box box-agencies hover-img2 ">
                                        <div className="images relative img-style2">
                                            <img className="img2" src="/assets/images/img-box/agencies-3.jpg" alt="images" />
                                        </div>
                                        <div className="icon-brand">
                                            <img src="/assets/images/img-box/agencies-brand-3.jpg" alt="images" />
                                        </div>
                                        <div className="content">
                                            <div className="title-group">
                                                <h3 className="link-style-1"><Link href="/agencies-detail">Lorem House</Link></h3>
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="box box-agencies hover-img2 ">
                                        <div className="images relative img-style2">
                                            <img className="img2" src="/assets/images/img-box/agencies-4.jpg" alt="images" />
                                        </div>
                                        <div className="icon-brand">
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="box box-agencies hover-img2 ">
                                        <div className="images relative img-style2">
                                            <img className="img2" src="/assets/images/img-box/agencies-5.jpg" alt="images" />
                                        </div>
                                        <div className="icon-brand">
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="box box-agencies hover-img2 ">
                                        <div className="images relative img-style2">
                                            <img className="img2" src="/assets/images/img-box/agencies-6.jpg" alt="images" />
                                        </div>
                                        <div className="icon-brand">
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="box box-agencies hover-img2 ">
                                        <div className="images relative img-style2">
                                            <img className="img2" src="/assets/images/img-box/agencies-7.jpg" alt="images" />
                                        </div>
                                        <div className="icon-brand">
                                            <img src="/assets/images/img-box/agencies-brand-7.jpg" alt="images" />
                                        </div>
                                        <div className="content">
                                            <div className="title-group">
                                                <h3 className="link-style-1"><Link href="/agencies-detail">Lorem House</Link></h3>
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="box box-agencies hover-img2 ">
                                        <div className="images relative img-style2">
                                            <img className="img2" src="/assets/images/img-box/agencies-8.jpg" alt="images" />
                                        </div>
                                        <div className="icon-brand">
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="box box-agencies hover-img2 ">
                                        <div className="images relative img-style2">
                                            <img className="img2" src="/assets/images/img-box/agencies-2.jpg" alt="images" />
                                        </div>
                                        <div className="icon-brand">
                                ...
                                <div className="col-lg-12">
                                    <div className="themesflat-pagination clearfix center style3">
                                        <ul>
