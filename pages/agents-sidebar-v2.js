...
export default function AgentSidebar2() {
    ...
    return (
        <>
            ...
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Property Listing">
                <div>
                    <section className="tf-section2 flat-agent flat-agent-sidebar flat-property style">
                        <div className="container">
                            <div className="row flex">
                                <div className="col-lg-8">
                                    <div className="post">
                                        <div className="category-filter flex align-center justify-space">
                                            <div className="box-1 ">
                                                <div className="heading-listing fs-30 lh-45 fw-7">Agents</div>
                                            </div>
                                        ...
                                        <div className="box flex hover-img">
                                            <div className="images relative flex-none img-style">
                                                <Link href="/agents-detail"><img src="/assets/images/img-box/agents-1.jpg" alt="images" /></Link>
                                            </div>
                                            <div className="content ">
                                                <h3 className="link-style-1"><Link href="/agents-detail">Darlene Robertson</Link></h3>
                                                <p className>Realtor</p>
                                                <div className="icon-group">
                                                    <div className="icon-phone link-style-1"><Link href="/tel:0123456789" className=" fw-7 font-2">+7-445-556-8337</Link></div>
                                                    <div className="icon-email"><Link href="/mailto:darlenerobertson@gmail.com" className="font-2">darlenerobertson@gmail.com</Link></div>
                                                </div>
                                        ...
                                        <div className="box flex hover-img">
                                            <div className="images relative flex-none img-style">
                                                <Link href="/agents-detail"><img src="/assets/images/img-box/agents-2.jpg" alt="images" /></Link>
                                            </div>
                                            <div className="content ">
                                                <h3 className="link-style-1"><Link href="/agents-detail">Darlene Robertson</Link></h3>
                                                <p className>Realtor</p>
                                        ...
                                        <div className="box flex hover-img">
                                            <div className="images relative flex-none img-style">
                                                <Link href="/agents-detail"><img src="/assets/images/img-box/agents-3.jpg" alt="images" /></Link>
                                            </div>
                                            <div className="content ">
                                                <h3 className="link-style-1"><Link href="/agents-detail">Darlene Robertson</Link></h3>
                                                <p className>Realtor</p>
                                        ...
                                        <div className="box flex hover-img">
                                            <div className="images relative flex-none img-style">
                                                <Link href="/agents-detail"><img src="/assets/images/img-box/agents-4.jpg" alt="images" /></Link>
                                            </div>
                                            <div className="content ">
                                                <h3 className="link-style-1"><Link href="/agents-detail">Darlene Robertson</Link></h3>
                                                <p className>Realtor</p>
                                        ...
                                        <div className="box flex hover-img">
                                            <div className="images relative flex-none img-style">
                                                <Link href="/agents-detail"><img src="/assets/images/img-box/agents-5.jpg" alt="images" /></Link>
                                            </div>
                                            <div className="content ">
                                                <h3 className="link-style-1"><Link href="/agents-detail">Darlene Robertson</Link></h3>
                                                <p className>Realtor</p>
                                        ...
                                        <div className="box flex hover-img">
                                            <div className="images relative flex-none img-style">
                                                <Link href="/agents-detail"><img src="/assets/images/img-box/agents-6.jpg" alt="images" /></Link>
                                            </div>
                                            <div className="content ">
                                                <h3 className="link-style-1"><Link href="/agents-detail">Darlene Robertson</Link></h3>
                                                <p className>Realtor</p>
                                        ...
                                        <div className="box flex hover-img">
                                            <div className="images relative flex-none img-style">
                                                <Link href="/agents-detail"><img src="/assets/images/img-box/agents-7.jpg" alt="images" /></Link>
                                            </div>
                                            <div className="content ">
                                                <h3 className="link-style-1"><Link href="/agents-detail">Darlene Robertson</Link></h3>
                                                <p className>Realtor</p>
                                        ...
                                        <div className="box flex hover-img">
                                            <div className="images relative flex-none img-style">
                                                <Link href="/agents-detail"><img src="/assets/images/img-box/agents-8.jpg" alt="images" /></Link>
                                            </div>
                                            <div className="content ">
                                                <h3 className="link-style-1"><Link href="/agents-detail">Darlene Robertson</Link></h3>
                                                <p className>Realtor</p>
                                        ...
                                        <div className="box flex hover-img">
                                            <div className="images relative flex-none img-style">
                                                <Link href="/agents-detail"><img src="/assets/images/img-box/agents-9.jpg" alt="images" /></Link>
                                            </div>
                                            <div className="content ">
                                                <h3 className="link-style-1"><Link href="/agents-detail">Darlene Robertson</Link></h3>
                                                <p className>Realtor</p>
                                        ...
                                        <div className="box flex hover-img">
                                            <div className="images relative flex-none img-style">
                                                <Link href="/agents-detail"><img src="/assets/images/img-box/agents-10.jpg" alt="images" /></Link>
                                            </div>
                                            <div className="content ">
                                                <h3 className="link-style-1"><Link href="/agents-detail">Darlene Robertson</Link></h3>
                                                <p className>Realtor</p>
