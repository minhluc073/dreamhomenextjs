...
export default function PropertyGridSidebar2() {
    ...
    return (
        <>
            ...
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Property Listing">
                <div>
                    <section className="flat-featured flat-property flat-property-grid-2 tf-section2 wg-dream style">
                                        ...
                                        <div className="wrap-item form-wg flex flex-wrap">
                                            ...
                                            <div className="box box-dream hv-one style-dream wg-box">
                                                ...
                                                <div className="content">
                                                    ...
                                                    <div className="days-box flex justify-space align-center">
                                                        <Link className="compare flex align-center fw-6" href="#">Compare</Link>
                                                        <div className="img-author hv-tool" data-tooltip="Kathryn Murphy"><img src="/assets/images/author/author-24.jpg" alt="images" /></div>
                                                        <div className="days">3 years ago</div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="box box-dream hv-one style-dream wg-box">
                                                ...
                                                <div className="content">
                                                    ...
                                                    <div className="days-box flex justify-space align-center">
                                                        <Link className="compare flex align-center fw-6" href="#">Compare</Link>
                                                        <div className="img-author hv-tool" data-tooltip="Kathryn Murphy"><img src="/assets/images/author/author-25.jpg" alt="images" /></div>
                                                        <div className="days">3 years ago</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="themesflat-pagination clearfix style2">
                                            <ul>
