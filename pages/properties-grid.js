    ...
    return (
        <>
            ...
            <Layout headerStyle={1} footerStyle={1}>
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="title-inner">
                                    <div className="title-group fs-12"><Link className="home fw-6 text-color-3" href="/">Home</Link><span>Property Listing</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section className="flat-featured flat-property-grid flat-property tf-section2 wg-dream home2">
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-12">
