...
export default function PropertyListSidebar2() {
    ...
    return (
        <>
            ...
            <Layout headerStyle={1} footerStyle={1}>
                ...
                <section className="tf-section2 flat-property flat-property-list flat-property-list1 flat-properties-rent wg-dream style5">
                    <div className="container6">
                        <div className="row flex">
                            <div className="post">
                                <div className="category-filter flex align-center justify-space">
                                    <div className="box-1 flex align-center">
                                        <div className="heading-listing fs-30 lh-45 fw-7">Property Listing</div><div className="heading-text">There are currently 164,814 properties.</div>
                                    </div>
                                ...
                                <div className="wrap-item form-wg flex flex-wrap">
                                    {/* col 1 */}
                                    <div className="box box-dream flex hv-one wg-box">
                                ...
                                <div className="themesflat-pagination clearfix style center">
                                    <ul>
