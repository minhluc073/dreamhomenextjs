...
export default function AgenciesSidebar1() {
    ...
    return (
        <>
            ...
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Property Listing">
                <div>
                    <section className="tf-section2 flat-agencies-sidebar flat-agencies flat-property  style">
                            ...
                            <div className="row flex">
                                <div className="col-lg-8">
                                    <div className="post">
                                        ...
                                        <div className="wrap-list flex flex-wrap form-wg">
                                            <div className="box box-agencies hover-img2 wg-box">
                                                <div className="images relative img-style2">
                                                    <img className="img2" src="/assets/images/img-box/agencies-1.jpg" alt="images" />
                                                </div>
                                        ...
                                        <div className="themesflat-pagination clearfix center style2">
                                            <ul>
