    ...
    return (
        <>
            ...
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Property Listing">
                <div>
                    <section className="tf-section2 flat-blog-grid flat-property style3">
                                ...
                                <div className="col-lg-8">
                                    <div className="post">
                                        <div className="category-filter flex  justify-space">
                                            <div className="box-1 ">
                                                <div className="heading-listing fs-30 lh-45 fw-7">Blog Grid</div>
                                            </div>
                                        ...
                                        <div className="flat-blog">
                                            <div className="box-heading ">
                                                <div className="image relative ">
                                                    <img src="/assets/images/img-box/blog-grid.jpg" alt="images" />
                                            ...
                                            <div className="wrap-blog form-wg flex flex-wrap">
                                                <div className="box hover-img wg-box">
                                                    <div className="images img-style relative ">
                                                        <img src="/assets/images/img-box/blog-grid-1.jpg" alt="images" />
                                                        <div className="sub-box flex align-center fs-13 fw-6">
                                                            <div className="title-1">April</div><a className="title-2 text-color-3">Housing</a>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="box hover-img wg-box">
                                                    <div className="images img-style relative ">
                                                        <img src="/assets/images/img-box/blog-grid-2.jpg" alt="images" />
                                                        <div className="sub-box flex align-center fs-13 fw-6">
                                                            <div className="title-1">April</div><a className="title-2 text-color-3">Housing</a>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="box hover-img wg-box">
                                                    <div className="images img-style relative ">
                                                        <img src="/assets/images/img-box/blog-grid-3.jpg" alt="images" />
                                                        <div className="sub-box flex align-center fs-13 fw-6">
                                                            <div className="title-1">April</div><a className="title-2 text-color-3">Housing</a>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="box hover-img wg-box">
                                                    <div className="images img-style relative ">
                                                        <img src="/assets/images/img-box/blog-grid-4.jpg" alt="images" />
                                                        <div className="sub-box flex align-center fs-13 fw-6">
                                                            <div className="title-1">April</div><a className="title-2 text-color-3">Housing</a>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="box hover-img wg-box">
                                                    <div className="images img-style relative ">
                                                        <img src="/assets/images/img-box/blog-grid-5.jpg" alt="images" />
                                                        <div className="sub-box flex align-center fs-13 fw-6">
                                                            <div className="title-1">April</div><a className="title-2 text-color-3">Housing</a>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="box hover-img wg-box">
                                                    <div className="images img-style relative ">
                                                        <img src="/assets/images/img-box/blog-grid-6.jpg" alt="images" />
                                                        <div className="sub-box flex align-center fs-13 fw-6">
                                                            <div className="title-1">April</div><a className="title-2 text-color-3">Housing</a>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="box hover-img wg-box">
                                                    <div className="images img-style relative ">
                                                        <img src="/assets/images/img-box/blog-grid-7.jpg" alt="images" />
                                                        <div className="sub-box flex align-center fs-13 fw-6">
                                                            <div className="title-1">April</div><a className="title-2 text-color-3">Housing</a>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="box hover-img wg-box">
                                                    <div className="images img-style relative ">
                                                        <img src="/assets/images/img-box/blog-grid-8.jpg" alt="images" />
                                                        <div className="sub-box flex align-center fs-13 fw-6">
                                                            <div className="title-1">April</div><a className="title-2 text-color-3">Housing</a>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="box hover-img wg-box">
                                                    <div className="images img-style relative ">
                                                        <img src="/assets/images/img-box/blog-grid-9.jpg" alt="images" />
                                                        <div className="sub-box flex align-center fs-13 fw-6">
                                                            <div className="title-1">April</div><a className="title-2 text-color-3">Housing</a>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="box hover-img wg-box">
                                                    <div className="images img-style relative ">
                                                        <img src="/assets/images/img-box/blog-grid-10.jpg" alt="images" />
                                                        <div className="sub-box flex align-center fs-13 fw-6">
                                                            <div className="title-1">April</div><a className="title-2 text-color-3">Housing</a>
                                                        </div>
                                                    </div>
