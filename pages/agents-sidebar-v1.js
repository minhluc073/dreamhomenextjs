...
export default function AgentSidebar1() {
    ...
    return (
        <>
            ...
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Property Listing">
                <div>
                    <section className="tf-section2 flat-agent-sidebar flat-property flat-meet style">
                            ...
                            <div className="row flex">
                                <div className="col-lg-8">
                                    <div className="post">
                                        ...
                                        <div className="wrap-list form-wg flex flex-wrap">
                                            <div className="box wg-box hover-img">
                                            ...
                                            <div className="box wg-box hover-img">
                                                <div className="images relative img-style">
                                                    <Link href="/agents-detail"><img src="/assets/images/img-box/meet-4.jpg" alt="images" /></Link>
                                                    <div className="icon-socials">
                                                        <Link href="#"><i className="fab fa-facebook-f" /></Link>
                                                        <Link href="#"><i className="fab fa-twitter" /></Link>
                                                        <Link href="#"><i className="fab fa-linkedin-in" /></Link>
                                            ...
                                            <div className="box wg-box hover-img">
                                                <div className="images relative img-style">
                                                    <Link href="/agents-detail"><img src="/assets/images/img-box/meet-5.jpg" alt="images" /></Link>
                                                    <div className="icon-socials">
                                                        <Link href="#"><i className="fab fa-facebook-f" /></Link>
                                                        <Link href="#"><i className="fab fa-twitter" /></Link>
                                                        <Link href="#"><i className="fab fa-linkedin-in" /></Link>
                                            ...
                                            <div className="box wg-box hover-img">
                                                <div className="images relative img-style">
                                                    <Link href="/agents-detail"><img src="/assets/images/img-box/meet-6.jpg" alt="images" /></Link>
                                                    <div className="icon-socials">
                                                        <Link href="#"><i className="fab fa-facebook-f" /></Link>
                                                        <Link href="#"><i className="fab fa-twitter" /></Link>
                                                        <Link href="#"><i className="fab fa-linkedin-in" /></Link>
                                            ...
                                            <div className="box wg-box hover-img">
                                                <div className="images relative img-style">
                                                    <Link href="/agents-detail"><img src="/assets/images/img-box/meet-7.jpg" alt="images" /></Link>
                                                    <div className="icon-socials">
                                                        <Link href="#"><i className="fab fa-facebook-f" /></Link>
                                                        <Link href="#"><i className="fab fa-twitter" /></Link>
                                                        <Link href="#"><i className="fab fa-linkedin-in" /></Link>
                                            ...
                                            <div className="box wg-box hover-img">
                                                <div className="images relative img-style">
                                                    <Link href="/agents-detail"><img src="/assets/images/img-box/meet-8.jpg" alt="images" /></Link>
                                                    <div className="icon-socials">
                                                        <Link href="#"><i className="fab fa-facebook-f" /></Link>
                                                        <Link href="#"><i className="fab fa-twitter" /></Link>
                                                        <Link href="#"><i className="fab fa-linkedin-in" /></Link>
                                            ...
                                            <div className="box wg-box hover-img">
                                                <div className="images relative img-style">
                                                    <Link href="/agents-detail"><img src="/assets/images/img-box/meet-9.jpg" alt="images" /></Link>
                                                    <div className="icon-socials">
                                                        <Link href="#"><i className="fab fa-facebook-f" /></Link>
                                                        <Link href="#"><i className="fab fa-twitter" /></Link>
                                                        <Link href="#"><i className="fab fa-linkedin-in" /></Link>
                                            ...
                                            <div className="box wg-box hover-img">
                                                <div className="images relative img-style">
                                                    <Link href="/agents-detail"><img src="/assets/images/img-box/meet-10.jpg" alt="images" /></Link>
                                                    <div className="icon-socials">
                                                        <Link href="#"><i className="fab fa-facebook-f" /></Link>
                                                        <Link href="#"><i className="fab fa-twitter" /></Link>
                                                        <Link href="#"><i className="fab fa-linkedin-in" /></Link>
                                            ...
                                            <div className="box wg-box hover-img">
                                                <div className="images relative">
                                                    <Link href="/agents-detail"><img src="/assets/images/img-box/meet-11.jpg" alt="images" /></Link>
                                                    <div className="icon-socials">
                                                        <Link href="#"><i className="fab fa-facebook-f" /></Link>
                                                        <Link href="#"><i className="fab fa-twitter" /></Link>
                                                        <Link href="#"><i className="fab fa-linkedin-in" /></Link>
                                            ...
                                            <div className="box wg-box hover-img">
                                                <div className="images relative img-style">
                                                    <Link href="/agents-detail"><img src="/assets/images/img-box/meet-12.jpg" alt="images" /></Link>
                                                    <div className="icon-socials">
                                                        <Link href="#"><i className="fab fa-facebook-f" /></Link>
                                                        <Link href="#"><i className="fab fa-twitter" /></Link>
                                                        <Link href="#"><i className="fab fa-linkedin-in" /></Link>
