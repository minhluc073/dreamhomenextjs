...
export default function PropertyGridSidebar1() {
    ...
    return (
        <>
            ...
            <Layout headerStyle={1} footerStyle={1}>
                ...
                <section className="flat-featured flat-property flat-property-grid-1 tf-section2 wg-dream style5">
                    <div className="container6">
                        <div className="row flex">
                            <div className="post">
                                <div className="category-filter flex justify-space align-center">
                                ...
                                <div className="wrap-item flex ">
                                    {/* col 1 */}
                                    <div className="box box-dream hv-one style-dream">
                                    ...
                                    <div className="box box-dream hv-one style-dream">
                                        ...
                                        <div className="content">
                                            ...
                                            <div className="days-box flex justify-space align-center">
                                                <Link className="compare flex align-center fw-6" href="#">Compare</Link>
                                                <div className="img-author hv-tool" data-tooltip="Kathryn Murphy"><img src="/assets/images/author/author-9.jpg" alt="images" /></div>
                                                <div className="days">3 years ago</div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="box box-dream hv-one style-dream">
                                        ...
                                        <div className="content">
                                            ...
                                            <div className="days-box flex justify-space align-center">
                                                <Link className="compare flex align-center fw-6" href="#">Compare</Link>
                                                <div className="img-author hv-tool" data-tooltip="Kathryn Murphy"><img src="/assets/images/author/author-10.jpg" alt="images" /></div>
                                                <div className="days">3 years ago</div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="box box-dream hv-one style-dream">
                                        ...
                                        <div className="content">
                                            ...
                                            <div className="days-box flex justify-space align-center">
                                                <Link className="compare flex align-center fw-6" href="#">Compare</Link>
                                                <div className="img-author hv-tool" data-tooltip="Kathryn Murphy"><img src="/assets/images/author/author-11.jpg" alt="images" /></div>
                                                <div className="days">3 years ago</div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="themesflat-pagination clearfix center style">
                                    <ul>
                            ...
                            <aside className="side-bar">
                                <div className="inner-side-bar">
                                    ...
                                    <div className="widget widget-listings style">
                                        ...
                                        <div className="box-listings flex hover-img3">
                                            <div className="img-listings img-style3">
                                                <img src="/assets/images/img-box/sidebar-listings-4.jpg" alt="images" />
                                            </div>
                                            <div className="content link-style-1">
                                                <Link className="fs-16 lh-24" href="/property-detail-v1">Gorgeous Apartment Building</Link>
                                                <h4>$7,500</h4>
                                        ...
                                        <div className="box-listings flex hover-img3">
                                            <div className="img-listings img-style3">
                                                <img src="/assets/images/img-box/sidebar-listings-5.jpg" alt="images" />
                                            </div>
                                            <div className="content link-style-1">
                                                <Link className="fs-16 lh-24" href="/property-detail-v1">Gorgeous Apartment Building</Link>
                                                <h4>$7,500</h4>
