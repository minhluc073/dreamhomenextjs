...
export default function PropertyDetails3() {
  ...
  return (
    <>
      ...
      >
        <div>
          <section className="flat-slider01 style">
              ...
              <div className="row">
                <div className="col-lg-12">
                  <div className="swiper-container mainslider2">
                    ...
                    <div className="swiper-pagination6" />
                  </div>
                </div>
              </div>
            </div>
          </section>
          <section className="flat-property-detail property-detail2 style2">
            <div className="container">
              <div className="row">
                    ...
                    <div className="wrap-video wrap-style">
                      ...
                      <div className="video-box center ">
                        <div className="post-video flex align-center justify-center relative">
                          <img
                            className="img-2"
                            src="/assets/images/img-box/property-video2.jpg"
                            alt="images"
                          />
                          <VideoPopup />
                        </div>
                    ...
                    <div className="wrap-virtual wrap-style">
                      ...
                      <div className="virtual-box relative flex align-center justify-center">
                        <div className="images">
                          <img
                            className="img-2"
                            src="/assets/images/img-box/property-06.jpg"
                            alt="images"
                          />
                        </div>
                    ...
                    <div className="wrap-review wrap-style">
                      <div className="box-title titles flex align-center justify-space">
                        <div className="inner flex align-center ">
                          <div className="title-style flex align-center ">
                            <div className="star flex">
                              <svg
                                version="1.1"
                                xmlns="http://www.w3.org/2000/svg"
